package com.lotrel.ltserwer.authModule.infrastructure.oauth2.service;
...
import com.lotrel.ltserwer.authModule.infrastructure.oauth2.user.OAuth2UserInfoFactory;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private final static String EMAIL_SPLITTER = "@";
    ...
    private Users registerNewUser(OAuth2UserRequest oAuth2UserRequest, OAuth2UserInfo oAuth2UserInfo) {
        ...
        UserDetails details = new UserDetails(oAuth2UserInfo);

        user.setProvider(AuthProvider.valueOf(oAuth2UserRequest.getClientRegistration().getRegistrationId()));
        user.setUserPortalToken(oAuth2UserInfo.getId());
        user.setUsername(oAuth2UserInfo.getEmail().split(EMAIL_SPLITTER)[0]);
